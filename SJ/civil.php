        ...
        <div class="container">
            <form action="civil.php" method="POST" enctype="multipart/form-data">
                ...
                <select id="options" name="options" onchange="showDescription()">
                    ...
                    <option value="Landlord and tenant disputes">Landlord and tenant disputes</option>
                    <option value="Juvenile misconduct">Juvenile misconduct</option>
                    <option value="Back rent">Back rent</option>
                    <option value="Unpaid personal loans">Unpaid personal loans</option>
                ...
                <label for="contracts">Contracts or Agreements:</label>
                <input type="file" id="contracts" name="contracts" accept=".pdf" required>
                <label for="correspondence">Correspondence Between Parties:</label>
                <input type="file" id="correspondence" name="correspondence" accept=".pdf" required>
                <label for="evidence">Documents or Evidence Supporting Claims/Defenses:</label>
                <input type="file" id="evidence" name="evidence" accept=".pdf, .jpg, .jpeg, .png" required>
